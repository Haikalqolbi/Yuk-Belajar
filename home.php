        ...
        <div class="container-fluid ">
          ...
          <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
            ...
            <ul class="navbar-nav mb-2 mb-lg-0">
                ...
                <li class="nav-item px-1">
                  <a class="nav-link" href="#" data-bs-target="#masuk" data-bs-toggle="modal" >Login</a>
                </li>
              </ul>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="masukLabel">Login</h5>
            ...
            <div class="text-center">
              <a class="btn btn-primary" href="loginuser.php"  style="color: white;">Login as User</a>
              </div>
              <hr>
              <div class="text-center">
                <a class="text-secondary" href="loginadmin.php">Login as admin</a>
              </div>
            </div>

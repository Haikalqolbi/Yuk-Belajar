...
<html lang="en">
  ...
  if(isset($_POST["submit"])){
    ...
    $query = "INSERT INTO tabel_produk VALUES 
                ('', 
                '$judul_product', 
                '$harga', 
                '$deskripsi',
...
<section class="m-5 p-5">
  <div class=" m-5 p-5 shadow-lg">
      <!-- Show Kosong -->
        <h1 class="fw-bold text-center">Tambah Program</h1>
         <form method="POST" action="" >
            <div class="mb-3">
                <label for="judul_product" class="form-label fw-bold">Judul Program</label>
                <input type="text" class="form-control" id="judul_product" name="judul_product" placeholder="Contoh: Program Coursera" >
            </div>
            <div class="mb-3">
                <label for="harga" class="form-label fw-bold">Harga</label>
                <input type="number" class="form-control" id="harga" name="harga" placeholder="*Hanya Masukan angka saja tanpa perlu karakter lainnya. Contoh: 100000" >
            </div>
            <div class="mb-3">
                <label for="deskripsi" class="form-label fw-bold">Deskripsi</label>
                <textarea class="form-control" id="deskripsi" name="deskripsi" rows="3" placeholder="Contoh: Coursera adalah Program..." ></textarea>
            </div>
            <div class="mb-3">
            ...
            <div class="text-center ">
                <button class="btn btn-primary w-50" type="submit" name="submit">Tambah</button>
            </div>
        </form>
        <!-- Show Buku close -->
  </div>
